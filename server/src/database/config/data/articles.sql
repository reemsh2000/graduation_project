...
VALUES 
  (
    ...
    'https://cdn.mos.cms.futurecdn.net/LxSugXzC4p7FkpSoJXqSnN-970-80.jpg.webp'
  ), 
    (
    'High-sugar diet disrupts the gut microbiome, leading to obesity', 
    ...
    'https://cdn.mos.cms.futurecdn.net/GtKQzPERHKxSESK849odaH-970-80.jpg.webp'
  ), 
    (
    ...
    'https://cdn.mos.cms.futurecdn.net/k2MRnuVELoJpemkRn3GQaD-970-80.jpg.webp'
  ), 
  (
    'Is protein good for weight loss?', 
    'While weight loss is not always the goal when it comes to leading a balanced lifestyle, making a few changes to your diet can be a helpful way to lose weight healthily. But instead of following a fad diet, why not follow the science? In which case, could simply eating more protein be good for weight loss? 
